don't forget to include changes to weights.py
...
The following file contains a modification to one of the mlrose_hiive package files, and must be used to replace the mlrose_hiive version:
weights.py
...
---- DATA SETS ----
My dataset is included in the repository, but can also be found at:

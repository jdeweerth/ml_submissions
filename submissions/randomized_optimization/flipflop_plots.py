...
# grid_search_parameters = ({"max_attempts": [10, 25, 50, 100, 200],
#                            "max_iters": [25, 50, 100, 250, 500, 1000],
#                            "restarts": [0, 5, 10, 25, 50],
#                            "random_state": 1})
...
ax.set_title("Flip Flop - Fitness vs Iterations")
...
fig.savefig(root_path + "/plots/flipflop/iterations.png")
...
ax.set_title("Flip Flop - Max Fitness vs Fitness Evaluations")
...
fig.savefig(root_path + "/plots/flipflop/evaluations.png")
...
ax.set_title("Flip Flop - Fitness vs Time")
...
fig.savefig(root_path + "/plots/flipflop/time.png")

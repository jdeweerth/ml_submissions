...
item_count = 5
weights = [randint(1, 3 * item_count) for w in range(item_count)]
# weights = [5, 1, 2, 10, 2]
values = [randint(1, item_count) for w in range(item_count)]
# values = [2, 2, 2, 3, 3]
max_weight_pct = 0.35
...
problem = mlrose.DiscreteOpt(length=item_count,
                             fitness_fn=fitness,
                             maximize=True,
                             max_val=item_count)
...
ax.set_title("Knapsack - Fitness vs Iterations")
...
fig.savefig(root_path + "/plots/knapsack/iterations.png")
...
ax.set_title("Knapsack - Max Fitness vs Fitness Evaluations")
...
fig.savefig(root_path + "/plots/knapsack/evaluations.png")
...
ax.set_title("Knapsack - Fitness vs Time")
...
fig.savefig(root_path + "/plots/knapsack/time.png")

...
fig.savefig(root_path + "/plots/frozenlakebig/vi_mean_val.png")
...
fig.savefig(root_path + "/plots/frozenlakebig/vi_max_val.png")
...
fig.savefig(root_path + "/plots/frozenlakebig/vi_error.png")
...
fig.savefig(root_path + "/plots/frozenlakebig/vi_time.png")
...
t = time()
P, R, env = get_fl()
pi = mdptoolbox.mdp.PolicyIteration(P, R, 0.99, max_iter=20, eval_type=1)
run_stats = pi.run()
policy = pi.policy
...
fig.savefig(root_path + "/plots/frozenlakebig/pi_mean_val.png")
...
fig.savefig(root_path + "/plots/frozenlakebig/pi_max_val.png")
...
fig.savefig(root_path + "/plots/frozenlakebig/pi_error.png")
...
fig.savefig(root_path + "/plots/frozenlakebig/pi_policy_change.png")
...
fig.savefig(root_path + "/plots/frozenlakebig/pi_time.png")
...
t = time()
P, R, env = get_fl()
ql = mdptoolbox.mdp.QLearning(P, R, 0.999999,
                              n_iter=10000000,
                              alpha_decay=1.0,
                              alpha=0.1,
...
fig.savefig(root_path + "/plots/frozenlakebig/ql_mean_val.png")
...
fig.savefig(root_path + "/plots/frozenlakebig/ql_max_val.png")
...
fig.savefig(root_path + "/plots/frozenlakebig/ql_error.png")
...
fig.savefig(root_path + "/plots/frozenlakebig/ql_time.png")
